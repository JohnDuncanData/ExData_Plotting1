...
plot(powerdatadates$DateTime, powerdatadates$Sub_metering_1, xlab="", ylab = "Energy sub metering", type = "l", lty=1)
lines(powerdatadates$DateTime, powerdatadates$Sub_metering_2, col="red")
lines(powerdatadates$DateTime, powerdatadates$Sub_metering_3, col="blue")
